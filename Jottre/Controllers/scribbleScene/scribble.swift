 ...
 */
class scribbleViewController: UIViewController, UIIndirectScribbleInteractionDelegate, UIScribbleInteractionDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let imageView = view as? UIImageView {
            imageView.image = #imageLiteral(resourceName: "AppIcon.dark")
        }
        */
